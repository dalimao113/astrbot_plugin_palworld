...
BOSS_ING = _IH + """</style></head><body><div class="page">
  ...
  <div class="ig-panel">
    <div class="ig-ivr" style="margin-top:0"><div class="ig-ivb"><div class="ivv">Lv.{{ level or "—" }}</div><div class="ivk">等级</div></div>{% if hp %}<div class="ig-ivb"><div class="ivv" style="color:var(--pal-danger)">{{ hp }}</div><div class="ivk">生命值</div></div>{% endif %}{% if base_hp %}<div class="ig-ivb"><div class="ivv" style="color:var(--pal-danger)">{{ base_hp }}</div><div class="ivk">基础生命</div></div>{% endif %}{% if attack %}<div class="ig-ivb"><div class="ivv" style="color:var(--pal-gold)">{{ attack }}</div><div class="ivk">基础攻击</div></div>{% endif %}{% if defense %}<div class="ig-ivb"><div class="ivv" style="color:var(--pal-accent)">{{ defense }}</div><div class="ivk">基础防御</div></div>{% endif %}</div>
    ...
    {% if location or coords %}<div class="ig-sec" style="margin-top:13px">所在</div><div style="font-size:14px;color:var(--pal-text-2)">{{ location }}{% if coords %} · 坐标 {{ coords }}{% endif %}</div>{% endif %}
...
BOSS_TMPL = _HEAD + """</style></head><body><div class="page">
  ...
  <div class="glass">""" + _GEMS + """
    <div style="display:grid;grid-template-columns:1fr 1fr;gap:10px">
      ...
      {% if hp %}<div style="background:rgba(12,8,38,.42);border:1px solid {{color}}44;border-radius:12px;padding:10px 12px"><div style="font-size:12px;color:#b9a9d6">生命值</div><div style="font-size:20px;font-weight:800;color:#ff9a9a">{{ hp }}</div></div>{% endif %}
      {% if base_hp %}<div style="background:rgba(12,8,38,.42);border:1px solid {{color}}44;border-radius:12px;padding:10px 12px"><div style="font-size:12px;color:#b9a9d6">基础生命</div><div style="font-size:20px;font-weight:800;color:#ff9a9a">{{ base_hp }}</div></div>{% endif %}
    ...
    {% if location or coords %}<div class="sec-t" style="margin-top:13px">📍 所在</div><div style="font-size:14.5px;color:#ece3f7">{{ location }}{% if coords %}<span style="display:inline-flex;align-items:center;gap:5px;margin-left:8px;background:rgba(12,8,38,.5);border:1px solid rgba(232,198,106,.3);border-radius:10px;padding:3px 10px;font-size:13px;color:#f3e3b0">🗺️ 坐标 <b style="color:#ffd86b">{{ coords }}</b></span>{% endif %}</div>{% endif %}
...
BOSS_PIX = _PH + """</style></head><body><div class="page">
  ...
  <div class="frame">
    <div style="display:grid;grid-template-columns:1fr 1fr;gap:9px">
      ...
      {% if hp %}<div style="background:rgba(221,198,149,.5);border:2px solid #6a4524;padding:9px 11px"><div style="font-size:12px;color:#574012">生命值</div><div style="font-size:19px;color:#8f1212">{{ hp }}</div></div>{% endif %}
      {% if base_hp %}<div style="background:rgba(221,198,149,.5);border:2px solid #6a4524;padding:9px 11px"><div style="font-size:12px;color:#574012">基础生命</div><div style="font-size:19px;color:#8f1212">{{ base_hp }}</div></div>{% endif %}
    ...
    {% if location or coords %}<div class="sec-t" style="margin-top:12px">所在</div><div style="font-size:14.5px;color:#46200a">{{ location }}{% if coords %}<span style="display:inline-block;margin-left:8px;background:rgba(156,107,26,.2);border:2px solid #6a4524;padding:2px 8px;font-size:13px;color:#46200a">坐标 {{ coords }}</span>{% endif %}</div>{% endif %}
