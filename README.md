...
![version](https://img.shields.io/badge/version-1.17.0-6366F1?style=flat-square)
...
| `/帕鲁养成 <帕鲁名>` | 读你存档里这只帕鲁的**浓缩星级/帕鲁之魂/觉醒/个体值/词条/技能**现状与目标差距（浓缩/魂精确材料数游戏未公开则不虚报，觉醒晶石按属性给）|
