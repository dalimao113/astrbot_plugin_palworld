...
![version](https://img.shields.io/badge/version-1.8.10-6366F1?style=flat-square)
...
| `/帕鲁主线 [页]` | 按剧情顺序列出 32 个主线任务 |
| `/帕鲁支线 [NPC]` | 32 个支线任务（可按 农民/学者/佐伊 等 NPC 筛选）|
...
| `/帕鲁据点` | 据点工作帕鲁状态：每只的属性/等级/**工作适性** + **濒死·重伤·饥饿**标记 + 受伤/饥饿汇总 |
