...
![version](https://img.shields.io/badge/version-1.34.0-6366F1?style=flat-square)
...
| `/帕鲁词条查 <词条名>` | **词条查帕鲁**：列出你队伍/帕鲁箱里带这个词条的帕鲁——帕鲁太多也能一键定位在哪只身上（箱编号与 `/帕鲁箱` 一致，带的档位用游戏品阶箭头显示）（也可 `/帕鲁查词条`）|
